      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <h3 className="text-lg font-semibold mb-4 text-theme-primary">{siteConfig.businessName}</h3>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {siteConfig.footerLinks.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="text-sm text-theme-secondary hover:text-theme-accent">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <address className="not-italic text-theme-secondary">
              ...
              <p className="text-sm">Tel: <a href={`tel:${siteConfig.phone}`} className="hover:text-theme-accent">{siteConfig.phone}</a></p>
              <p className="text-sm">Email: <a href={`mailto:${siteConfig.email}`} className="hover:text-theme-accent">{siteConfig.email}</a></p>
            </address>
              ...
              <div className="mt-4">
                ...
                <div className="flex space-x-4 items-center">
                  ...
                  {siteConfig.social.instagram && (
                    <Link href={siteConfig.social.instagram} aria-label="Instagram" target="_blank" rel="noopener noreferrer" className="text-theme-muted hover:text-theme-accent">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {siteConfig.social.telegram && (
                    <Link href={siteConfig.social.telegram} aria-label="Telegram" target="_blank" rel="noopener noreferrer" className="text-theme-muted hover:text-theme-accent">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  {siteConfig.social.linkedin && (
                    <Link href={siteConfig.social.linkedin} aria-label="LinkedIn" target="_blank" rel="noopener noreferrer" className="text-theme-muted hover:text-theme-accent">
                      <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
